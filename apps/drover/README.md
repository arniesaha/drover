...
Expect `** TEST SUCCEEDED **`. As of this writing that's 175 tests total — 154 Swift-Testing tests in 13 suites plus 21 XCTest cases (DisplayBlocksTests 12 + EditDiffTests 9) under DroverTests.xctest.
